...
namespace Ryujinx.Graphics.Vulkan
{
    internal class HostMemoryAllocator
    {
        ...
        public HostMemoryAllocator(Vk api, Device device)
        {
            _api = api;
            _device = device;
        ...
        public unsafe bool TryImport(
            ...
            ulong size)
        {
            int memoryTypeIndex = MemoryAllocator.FindSuitableMemoryTypeIndex(_api, physicalDevice, requirements.MemoryTypeBits, flags, flags);
