...
namespace Ryujinx.Graphics.Vulkan
{
    class PipelineBase : IDisposable
    {
        ...
        public void ClearBuffer(BufferHandle destination, int offset, int size, uint value)
        {
            ...
            var dst = Gd.BufferManager.GetBuffer(CommandBuffer, destination, true).Get(Cbs, offset, size, true).Value;
        ...
        public void MultiDrawIndirectCount(BufferRange indirectBuffer, BufferRange parameterBuffer, int maxDrawCount, int stride)
        {
            ...
            var buffer = Gd.BufferManager.GetBuffer(CommandBuffer, indirectBuffer.Handle, true).Get(Cbs, indirectBuffer.Offset, indirectBuffer.Size, true).Value;
            var countBuffer = Gd.BufferManager.GetBuffer(CommandBuffer, parameterBuffer.Handle, true).Get(Cbs, parameterBuffer.Offset, parameterBuffer.Size, true).Value;
